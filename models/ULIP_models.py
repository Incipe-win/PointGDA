...
class ULIP_WITH_IMAGE(nn.Module):
    ...
    def forward(self, pc, text, image=None):
        ...
        if image is not None:
            ...
            return {"text_embed": text_embed_all, "pc_embed": pc_embed, "logit_scale": self.logit_scale.exp()}
...
def ULIP_PN_SSG(args):
    ...
    if not args.evaluate_3d:
        ...
        pretrain_slip_model_params = {
            param_name.replace("module.", ""): param for param_name, param in pretrain_slip_model_params.items()
        }
